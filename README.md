...
放在这里的翻译项目, 是通过 翻译工具 翻译的, 可以认为是`初稿`, 我想世界上, 没有说, 使用翻译工具后, 所有的

语句, 和 幽默笑话😊都是成功的, 但 创建 `translate-mds` 的初衷 是为了可以懒, 

想想看, 屏幕一边是原文, 一边是经过翻译还没打磨的译文, 总好过, 从头开始一字一段的开始打好吧👌

⚠️ 在这个列表中的, 大型项目, 我不打算经过人工打磨, 可以看作是 项目生产的 真实样貌

## 欢迎Issue

`translate-mds` 项目运行问题 https://github.com/chinanf-boy/translate-mds/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc
